...
export default function LabBillingClient() {
  ...
  const { data, isLoading } = useQuery<BillingReport>({
    queryKey: ['lab-tech-billing', queryParams],
    queryFn: async () => {
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            All billings auto-generated when you upload reports. Track commission payouts to doctors.
          </p>
        </div>
        <Button
        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-muted-foreground font-medium">No billings found</p>
              <p className="text-sm text-muted-foreground mt-1">
                Billings appear automatically when you upload reports for completed orders
              </p>
            </div>
          ) : (
              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-slate-200">
                    ...
                    <TableHead className="hidden xl:table-cell">Txn Ref</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {billings.map((b) => (
                    <TableRow key={b.id} className="border-slate-200">
                      ...
                      <TableCell className="text-right hidden md:table-cell font-mono text-sm text-emerald-700">
                      ...
                      <TableCell className="hidden xl:table-cell text-xs text-emerald-600 max-w-[140px] truncate">
                        {b.transactionRef || '—'}
                      </TableCell>
                    </TableRow>
                  ))}
