...
export default function BlogListPage() {
  ...
  const { data, isLoading } = useQuery<{ posts: BlogPost[] }>({
    queryKey: ['receptionist-posts'],
    queryFn: () => fetch('/api/receptionist/posts').then((r) => r.json()),
  })
  ...
  const deleteMutation = useMutation({
    mutationFn: (id: string) =>
      fetch(`/api/receptionist/posts/${id}`, { method: 'DELETE' }).then((r) =>
        r.json()
      ),
    onSuccess: () => {
  ...
  return (
    <div className="space-y-8">
      ...
      >
        ...
        >
          <Link href="/dashboard/receptionist/blog/new">
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="flex items-center gap-2 pt-1">
                    <Button variant="outline" size="sm" asChild>
                      <Link href={`/dashboard/receptionist/blog/${post.id}/edit`}>
