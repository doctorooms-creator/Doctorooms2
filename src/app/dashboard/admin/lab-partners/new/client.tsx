...
export default function NewLabPartnerClient() {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      toast.success('Lab partner created')
      router.push('/dashboard/admin/lab-partners')
    },
    onError: (error) => {
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight flex items-center gap-2">
            ...
            Register New Lab Partner
          </h1>
          <p className="text-muted-foreground text-sm mt-1">
            Create a diagnostic lab partner account and link it to your hospital network
          </p>
        </div>
      </div>
      ...
      >
        <Card className="border-slate-200 max-w-3xl mx-auto">
          <CardHeader>
            ...
            <CardDescription>
              Fill in the lab information. Fields marked with * are required.
            </CardDescription>
          </CardHeader>
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-xs text-muted-foreground">
                      Applied when a doctor associates with this lab
                    </p>
                  </div>
                  <div className="space-y-2">
